...
static const char *fonts[]          = { "JetBrainsMono:size=12", "SauceCodePro Nerd Font:size=14" };
...
static const Key keys[] = {
	...
	//{ MODKEY,    	                XK_masculine,      togglegaps,     {0} },
	...
	{ MODKEY,                       XK_Tab,    setlayout,      {.v = &layouts[7]} },
	{ MODKEY|ShiftMask,             XK_Tab,    setlayout,      {.v = &layouts[8]} },
